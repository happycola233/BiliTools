...
- **外观**：选择跟随系统、浅色或深色模式，使用动态取色或十三套内置配色；可开启纯黑主题、切换液态玻璃底栏并调整其宽度。
...
- **液态玻璃底栏**：底部导航采用透明、模糊与折射效果，支持拖动选中项切换页面与调整底栏宽度。若不喜欢液态玻璃风格，可在「设置 → 外观」中关闭「液态玻璃底栏」，切换为 Material 风格底栏。下载页的打开与分享菜单采用相同的玻璃效果。
