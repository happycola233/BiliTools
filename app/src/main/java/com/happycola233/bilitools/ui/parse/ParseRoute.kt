...
fun ParseRoute(
    ...
    ParseScreenContent(
        ...
        onAppendPage = viewModel::appendNextPage,
        ...
        onRetrySubtitles = viewModel::retrySubtitleDiscovery,
        onEmbedSubtitlesEnabledChange = viewModel::setEmbedSubtitlesEnabled,
        onEmbedSubtitleSelectionChange = viewModel::setEmbedSubtitleSelection,
